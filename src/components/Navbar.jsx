...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="flex justify-between items-center py-3 border-none lg:border px-2 fixed top-0
       left-0 right-0 bg-[#f5f5f5ff] z-20"
      >
        <div className="flex flex-col lg:flex-row justify-between items-center mx-auto lg:mx-0">
          ...
          <div className="flex text-{24px} lg:text-{15px} gap-5 text-gray-500 font-semibold h-full">
